...
import {
  GetRequisiteV3BankAccountDto,
  GetRequisiteV3BankDto,
  GetRequisiteV3DropDto,
  GetRequisiteV3NeoBankDto,
  GetRequisiteV3PlatformDto,
  GetRequisiteV3ResponseDto,
  GetRequisiteV3ShiftDto,
} from './get-requisite-v3.response.dto';

@Injectable()
export class GetRequisiteV3Service {
  constructor(
  ...
  async execute(user: User): Promise<GetRequisiteV3ResponseDto> {
    ...
    return new GetRequisiteV3ResponseDto({
      shift: new GetRequisiteV3ShiftDto({
        id: activeShift.id,
        platform: new GetRequisiteV3PlatformDto({
          id: activeShift.platform.id,
          name: activeShift.platform.name,
          exchangeRate: Number(activeShift.platform.exchangeRate),
        }),
      }),
      bankAccount: new GetRequisiteV3BankAccountDto({
        id: bankAccount.id,
        cbu: bankAccount.cbu,
        ...
        bank: new GetRequisiteV3BankDto({
          id: bankAccount.bank.id,
          name: bankAccount.bank.name,
        }),
        drop: new GetRequisiteV3DropDto({
